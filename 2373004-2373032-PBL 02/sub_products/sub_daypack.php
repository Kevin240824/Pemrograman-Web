...
<head>
  <title>CUMBREPACK Outdoor Gear - Day Pack</title>
  <meta charset="utf-8">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="section-header d-flex flex-wrap justify-content-between mb-3">
            ...
            <h2 class="section-title text-capitalize">Day Pack Products</h2>
            ...
            <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4">
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/daypack/daypack3.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Varkal Day Pack</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$220.00</del>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/daypack/daypack5.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Nyxen Day Pack</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$210.00</del>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/daypack/daypack6.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">UrbanForge 16 Day Pack</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$110.00</del>
                      <span class="text-dark fw-semibold">$100.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/daypack/daypack7.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">SprintCore 21 Day Pack</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$40.00</del>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/daypack/daypack8.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">NordicLite 16 Day Pack</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$88.00</del>
                      <span class="text-dark fw-semibold">$78.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/daypack/daypack9.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">PackAway 16 Day Pack</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$70.00</del>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/daypack/daypack10.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">EcoStride 17 Day Pack</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$24.00</del>
                      <span class="text-dark fw-semibold">$14.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
