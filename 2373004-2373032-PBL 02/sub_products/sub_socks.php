...
<head>
  <title>CUMBREPACK Outdoor Gear - Socks</title>
  <meta charset="utf-8">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="section-header d-flex flex-wrap justify-content-between mb-3">
            ...
            <h2 class="section-title text-capitalize">Socks Products</h2>
            ...
            <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4">
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/kaoskaki/kaoskaki2.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">DexTrekto Socks</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$40.00</del>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/kaoskaki/kaoskaki3.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Silvatrek Socks</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$55.00</del>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/kaoskaki/kaoskaki4.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">SyncroWeave Socks</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$45.00</del>
                      <span class="text-dark fw-semibold">$35.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/kaoskaki/kaoskaki5.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">CoreStride Socks</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$35.00</del>
