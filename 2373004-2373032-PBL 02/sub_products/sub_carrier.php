...
<head>
  <title>CUMBREPACK Outdoor Gear - Carrier</title>
  <meta charset="utf-8">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="section-header d-flex flex-wrap justify-content-between mb-3">
            ...
            <h2 class="section-title text-capitalize">Carrier Products</h2>
            ...
            <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4">
              ...
              <div class="col">
                <div class="product-item mb-4">
                  ...
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Wolftrail 55+5L Carrier</h3>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  ...
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">FalconRidge 45+L Carrier</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$430.00</del>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/carrier/carrier3.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Lyconix 30+L Women's Carrier</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$260.00</del>
                      <span class="text-dark fw-semibold">$250.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/carrier/carrier4.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Solarka 55L Carrier</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$240.00</del>
                      <span class="text-dark fw-semibold">$230.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/carrier/carrier5.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Aquila Layer Women's Carrier</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$180.00</del>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/carrier/carrier6.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">TrailTrek Tots Carrier</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$125.00</del>
                      <span class="text-dark fw-semibold">$115.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/carrier/carrier7.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">GreenStride Voyager Carrier</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$115.00</del>
                      <span class="text-dark fw-semibold">$105.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/carrier/carrier8.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">HikeNest Pro Carrier</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$155.00</del>
                      <span class="text-dark fw-semibold">$145.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/carrier/carrier9.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">SummitAura 44 Carrier</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$260.00</del>
                      <span class="text-dark fw-semibold">$250.00</span>
                      <span
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/carrier/carrier10.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">RoverBloom Classic Carrier</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$130.00</del>
