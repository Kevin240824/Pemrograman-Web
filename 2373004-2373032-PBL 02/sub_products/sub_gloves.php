...
<head>
  <title>CUMBREPACK Outdoor Gear - Gloves</title>
  <meta charset="utf-8">
      ...
      <div class="row">
        <div class="col-lg-5 py-5 my-5 text-white">
          ...
          <div class="d-flex gap-3">
            <a href="../home/viewallProducts.html"
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="section-header d-flex flex-wrap justify-content-between mb-3">
            ...
            <h2 class="section-title text-capitalize">Glove Products</h2>
            ...
            <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4">
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/gloves/gloves3.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Aerovant GTX</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$75.00</del>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/gloves/gloves4.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Noirclaw XTR</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$80.00</del>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/gloves/gloves5.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Frostwind Trail</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$90.00</del>
                      <span class="text-dark fw-semibold">$80.00</span>
                      <span
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/gloves/gloves6.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Golden Glove Nitrile Examination Glove</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$19.00</del>
                      <span class="text-dark fw-semibold">$9.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/gloves/gloves7.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">OneMed Latex Medical Examination Glove</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$14.20</del>
                      <span class="text-dark fw-semibold">$4.20</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/gloves/gloves8.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">OneMed Nitrile Exam Glove</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$22.00</del>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/gloves/gloves9.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">OneMed Latex Exam Glove</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$21.00</del>
                      <span class="text-dark fw-semibold">$11.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/gloves/gloves10.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">OneMed Medi Exam Glove</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$32.00</del>
