...
<head>
  <title>CUMBREPACK Outdoor Gear - Windbreaker Jacket</title>
  <meta charset="utf-8">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form action="../homeprocess_login.php" method="post">
                    <div class="mb-3">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="section-header d-flex flex-wrap justify-content-between mb-3">
            ...
            <h2 class="section-title text-capitalize">Wind Breaker Products</h2>
            ...
            <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4">
                ...
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/wbreaker/wbreaker1.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">AnginX Wind Breaker</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$135.00</del>
                      <span class="text-dark fw-semibold">$125.00</span>
                      <span
              ...
              <div class="col">
                <div class="product-item mb-4">
                  ...
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Stormveil Wind Breaker</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$124.00</del>
                      <span class="text-dark fw-semibold">$114.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/wbreaker/wbreaker3.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">ZephyrGuard Wind Breaker</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$210.00</del>
                      <span class="text-dark fw-semibold">$200.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/wbreaker/wbreaker4.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Windraze Wind Breaker</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$225.00</del>
                      <span class="text-dark fw-semibold">$215.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/wbreaker/wbreaker5.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">AeroTrek</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$300.00</del>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/wbreaker/wbreaker6.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">GustLayer Wind Breaker</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$220.00</del>
                      <span class="text-dark fw-semibold">$210.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/wbreaker/wbreaker7.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">VentoVibe Wind Breaker</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$400.00</del>
                      <span class="text-dark fw-semibold">$390.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/wbreaker/wbreaker8.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">HazeShell Wind Breaker</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$230.00</del>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/wbreaker/wbreaker9.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Skyrift Wind Breaker</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$275.00</del>
                      <span class="text-dark fw-semibold">$265.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/wbreaker/wbreaker10.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Blastrail</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$120.00</del>
