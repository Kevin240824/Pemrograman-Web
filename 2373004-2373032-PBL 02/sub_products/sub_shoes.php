...
<head>
  <title>CUMBREPACK Outdoor Gear - Shoes</title>
  <meta charset="utf-8">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="section-header d-flex flex-wrap justify-content-between mb-3">
            ...
            <h2 class="section-title text-capitalize">Shoe Products</h2>
            ...
            <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4">
                ...
                <div class="product-item mb-4">
                  ...
                  <div class="d-flex flex-column text-center">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$450.00</del>
                      <span class="text-dark fw-semibold">$440.00</span>
                      <span
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/sepatu/sepatu2.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">SummitFlow XTR</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$520.00</del>
                      <span class="text-dark fw-semibold">$510.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/sepatu/sepatu3.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">DuneRidge Trek Pro</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$530.00</del>
                      <span class="text-dark fw-semibold">$520.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/sepatu/sepatu4.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">UltraLock Terrain GTX</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$565.00</del>
                      <span class="text-dark fw-semibold">$555.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/sepatu/sepatu5.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">CloudTrek Elemental</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$625.00</del>
                      <span class="text-dark fw-semibold">$625.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
