...
<head>
  <title>CUMBREPACK Outdoor Gear - Tents</title>
  <meta charset="utf-8">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="section-header d-flex flex-wrap justify-content-between mb-3">
            ...
            <h2 class="section-title text-capitalize">Tent Products</h2>
            ...
            <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4">
                ...
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/tents/tent1.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Canopyra Tent</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$500.00</del>
                      <span class="text-dark fw-semibold">$490.00</span>
                      <span
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/tents/tent2.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Lentara Tent</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$440.00</del>
                      <span class="text-dark fw-semibold">$430.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/tents/tent3.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Shelterra</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$390.00</del>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/tents/tent4.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Astra Tent</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$680.00</del>
                      <span class="text-dark fw-semibold">$670.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/tents/tent5.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Trekdomo Tent</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$770.00</del>
                      <span class="text-dark fw-semibold">$760.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/tents/tent6.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">VentureVault Tent</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$420.00</del>
                      <span class="text-dark fw-semibold">$410.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/tents/tent7.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Campora Tent</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$555.00</del>
                      <span class="text-dark fw-semibold">$545.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/tents/tent8.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Noktura Tent</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$777.00</del>
                      <span class="text-dark fw-semibold">$767.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/tents/tent9.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Domescape Tent</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$666.00</del>
                      <span class="text-dark fw-semibold">$656.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/tents/tent10.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Pendura Tent</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$888.00</del>
                      <span class="text-dark fw-semibold">$878.00</span>
                      <span
                        class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10%
                        OFF</span>
                    </div>
        ...
        <div class="col-md-2 col-sm-6">
          <div class="footer-menu">
            ...
            <ul class="menu-list list-unstyled">
              ...
              <li class="menu-item">
                <a href="../footer/mounteneering.png" class="nav-link">Our Blog</a>
              </li>
              <li class="menu-item">
