...
<html lang="en">
  <head>
    <title>CUMBREPACK Outdoor Gear - Others</title>
    <meta charset="utf-8">
        ...
        <div class="row">
          <div class="col-lg-5 py-5 my-5 text-white">
            ...
            <div class="d-flex gap-3">
              <a href="../home/viewallProducts.php" class="btn btn-dark text-uppercase fs-6 rounded-pill px-5 py-4 mt-3">Start Shopping</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap justify-content-between mb-3">
              ...
              <h2 class="section-title text-capitalize">Other Products</h2>
