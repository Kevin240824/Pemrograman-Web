    ...
    <div class="container-lg">
      <div class="row">
        <div class="col-md-12">
          <div class="section-header d-flex flex-wrap justify-content-between mb-3">
            <h2 class="detail-product-title w-100">Wolftrail Carrier 55+5L</h2>
          </div>
        </div>
      </div>
      ...
      <div class="row align-items-center"> <!-- Tambahkan align-items-center untuk vertikal center -->
        ...
        <div class="col-lg-6 col-md-6">
          <figure>
            <img src="../imagecumbre/carrier/carrier1.jpg" class="img-fluid img-product-detail">
          </figure>
        </div>
        ...
        <div class="col-lg-6 col-md-6">
          <main class="product-container">
            ...
            <div class="product-description">
              <p>Kenyamanan maksimal dan performa optimal dengan base layer berteknologi tinggi yang elastis,
                breathable, dan cepat kering, serta dirancang khusus untuk mendukung setiap gerakan.</p>
            </div>
              ...
              <form id="cartForm" method="POST" action="">
                ...
                <div class="color-option">
                  ...
                  <div class="color-swatches">
                    ...
                    <span class="swatch white" data-color-id="2" style="background-color: white;"></span>
                  </div>
                  <input type="hidden" id="selected_variasi" name="variasi_id" value="13">
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      document.querySelectorAll('.color-swatches .swatch').forEach(swatch => {
        swatch.addEventListener('click', function() {
          ...
          const variasiId = colorId === '1' ? 13 : 14;
