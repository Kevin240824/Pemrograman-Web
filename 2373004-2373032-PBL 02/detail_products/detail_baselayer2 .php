...
<head>
  <title>CUMBREPACK Outdoor Gear - Wolfy Layer Women's</title>
  <meta charset="utf-8">
    ...
    <div class="container-lg">
      <div class="row">
        <div class="col-md-12">
          <div class="section-header d-flex flex-wrap justify-content-between mb-3">
            <h2 class="detail-product-title w-100">Thery Layer Women's </h2>
          </div>
        </div>
      </div>
      ...
      <div class="row align-items-center"> <!-- Tambahkan align-items-center untuk vertikal center -->
        ...
        <div class="col-lg-6 col-md-6">
          <figure>
            <img src="../imagecumbre/blayer/blayer2.jpg" class="img-fluid img-product-detail">
          </figure>
        </div>
        ...
        <div class="col-lg-6 col-md-6">
          <main class="product-container">
            ...
            <div class="product-description">
              <p>Designed for women who move, the TheryLayer Base Layer combines soft, breathable fabric with advanced temperature regulation to keep you comfortable in any condition.
                Its moisture-wicking properties keep sweat at bay, while the lightweight, stretchy material ensures full freedom of movement.
                Perfect for hiking, running, or cold-weather training, this base layer fits snugly under any outfit without bulk, providing seamless warmth and performance.</p>
            </div>
              ...
              <form id="cartForm" method="POST" action="">
                ...
                <div class="color-option">
                  ...
                  <div class="color-swatches">
                    ...
                    <span class="swatch red" data-color-id="3" style="background-color: red;"></span>
                  </div>
                </div>
                <div class="size-option">
                  ...
                  <div class="size-selector">
                    <!-- Untuk warna hitam -->
                    <span class="size active" data-variasi-id="1">M</span>
                    <span class="size" data-variasi-id="2">L</span>
                    <span class="size" data-variasi-id="3">XL</span>
            ...
            cartItems.forEach(item => {
              ...
              listItem.innerHTML = `
                        <div class="d-flex align-items-center flex-grow-1">
                            <img src="../imagecumbre/blayer/blayer2.jpg" alt="${item.nama_produk}" width="60" height="60" class="rounded me-3">
