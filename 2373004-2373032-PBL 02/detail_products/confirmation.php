...
<head>
  ...
  <title>Order Confirmation - CUMBREPACK</title>
      ...
      <div class="row py-4">
        ...
        <div
          ...
          <div class="d-flex align-items-center my-3 my-sm-0">
            ...
            <a href="../home/homepage.html" class="nav-link">
              <h3>CUMBREPACK</h3>
            </a>
            </a>
          </div>
  ...
  <div class="search-bar row border border-light-subtle bg-light p-2 py-1 rounded-1">
    <div class="col-md-4 d-none d-md-block">
      <select class="form-select border-0 bg-transparent" onchange="location = this.value;">
        ...
        <option value="../home/men.html">Men</option>
        <option value="../home/women.html">Women</option>
      </select>
    </div>
            ...
            <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu border-0 rounded-0 shadow" aria-labelledby="pages">
                  <li><a href="Aboutus_footer.html" class="dropdown-item">About Us </a></li>
                  <li><a href="Newspage_footer.html" class="dropdown-item">Our Blog </a></li>
                  <li><a href="Sustainbility_footer.html.html" class="dropdown-item">Sustainibility </a></li>
                  <li><a href="FAQ_footer.html" class="dropdown-item">FAQ </a></li>
                </ul>
              </li>
            </ul>
          </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
          ...
          <p class="lead mb-4">Your order #12345 has been confirmed and will be shipped soon.</p>
          <p class="mb-5">A confirmation email has been sent to john.doe@example.com</p>

          <div class="order-details text-start mb-5">
            <div class="row">
              <div class="col-md-6 mb-4">
                <h3 class="h5 mb-3">Order Details</h3>
                <p class="mb-1"><strong>Order Number:</strong> #12345</p>
                <p class="mb-1"><strong>Date:</strong> June 15, 2025</p>
                <p class="mb-1"><strong>Total:</strong> $403.80</p>
                <p class="mb-1"><strong>Payment Method:</strong> Visa ending in 3456</p>
              </div>
              <div class="col-md-6 mb-4">
                <h3 class="h5 mb-3">Shipping Address</h3>
                <p class="mb-1">John Doe</p>
                <p class="mb-1">123 Main St, Apt 4B</p>
                <p class="mb-1">Los Angeles, CA 90210</p>
            ...
            <div class="order-item mb-3 pb-3 border-bottom">
              <div class="row align-items-center">
                <div class="col-2">
                  <img src="../imagecumbre/blayer/blayer1.jpg" alt="Wolfy Layer Women's" class="img-fluid">
                </div>
                <div class="col-6">
                  <h4 class="h6 mb-1">Wolfy Layer Women's</h4>
                  <p class="small mb-1">Color: Black | Size: M</p>
                </div>
                <div class="col-2 text-center">
                  <p class="mb-1">Qty: 1</p>
                </div>
                <div class="col-2 text-end">
                  <p class="mb-0 fw-bold">$360.00</p>
                </div>
              </div>
            </div>
            ...
            <div class="order-totals mt-4">
              ...
              <div class="d-flex justify-content-between mt-3 pt-2 border-top">
                ...
                <span class="fw-bold">$403.80</span>
              </div>
            </div>
          </div>

          <div class="d-flex justify-content-center gap-3">
            <a href="../home/homepage.html" class="btn btn-outline-dark px-5 py-3">Continue Shopping</a>
            <a href="#" class="btn btn-dark px-5 py-3">View Order Details</a>
          </div>
        </div>
      </div>
    </div>
