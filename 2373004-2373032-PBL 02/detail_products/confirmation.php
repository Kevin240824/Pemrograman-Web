            ...
            <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu border-0 rounded-0 shadow" aria-labelledby="pages">
                  <li><a href="Aboutus_footer.php" class="dropdown-item">About Us </a></li>
                  <li><a href="Newspage_footer.php" class="dropdown-item">Our Blog </a></li>
                  <li><a href="Sustainbility_footer.php" class="dropdown-item">Sustainibility </a></li>
                  <li><a href="FAQ_footer.php" class="dropdown-item">FAQ </a></li>
                </ul>
              </li>
            </ul>
          </div>
