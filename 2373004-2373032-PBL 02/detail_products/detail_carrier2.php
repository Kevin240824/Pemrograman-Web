    ...
    <div class="container-lg">
      <div class="row">
        <div class="col-md-12">
          <div class="section-header d-flex flex-wrap justify-content-between mb-3">
            <h2 class="detail-product-title w-100">FalconRidge 45+L Carrier</h2>
          </div>
        </div>
      </div>
      ...
      <div class="row align-items-center"> <!-- Tambahkan align-items-center untuk vertikal center -->
        ...
        <div class="col-lg-6 col-md-6">
          <figure>
            <img src="../imagecumbre/carrier/carrier2.jpg" class="img-fluid img-product-detail">
          </figure>
        </div>
        ...
        <div class="col-lg-6 col-md-6">
          <main class="product-container">
            ...
            <div class="product-description">
              <p>Engineered for explorers who demand rugged reliability, the FalconRidge 45+L Carrier delivers unmatched capacity and comfort for extended treks. 
                Its ergonomic suspension system evenly distributes weight, reducing strain on your back and shoulders, while the durable, weather-resistant construction stands up to the toughest conditions. 
                With customizable compartments, reinforced attachment points, and intuitive accessibility, this carrier keeps your gear secure and organized—whether you're scaling mountains or traversing remote trails.</p>
            </div>
              ...
              <form id="cartForm" method="POST" action="">
                ...
                <div class="color-option">
                  ...
                  <div class="color-swatches">
                    <!-- Tambahkan data-variasi-id sesuai variasi di database -->
                    <span class="swatch black active" data-variasi-id="1"
                      style="background-color: black; border: 1px solid #333;"></span>
                    <span class="swatch white" data-variasi-id="2"
                      style="background-color: white; border: 1px solid #ddd;"></span>
                  </div>
                </div>
                ...
                <input type="hidden" id="selected_variasi" name="variasi_id" value="15"> <!-- Default variasi -->
  ...
  <script src="js/script.js"></script>
   ...
   <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      // Update the color selection to directly set variasi_id
      document.querySelectorAll('.color-swatches .swatch').forEach(swatch => {
        swatch.addEventListener('click', function() {
          ...
          const variasiId = colorId === '1' ? 15 : 16;
          document.getElementById('selected_variasi').value = variasiId;
        });
      });

      // // Set default variasi_id to black carrier (13)
      // document.getElementById('selected_variasi').value = 13;
    ...
    function updatewishBadge() {
      fetch('get_wish_count.php')
        .then(response => response.json())
        .then(data => {
          document.getElementById('wish-badge').textContent = data.count;
        });
    }
      ...
      fetch('add_to_wish.php', {
        ...
        .then(data => {
          if (data.success) {
            ...
            // Update wish badge
            document.getElementById('wish-badge').textContent = data.wish_count;
          } else {
            alert('Error: ' + data.message);
          }
        })
      ...
      fetch('get_wish.php')
        ...
        .then(wishItems => {
          ...
          if (wishItems.length === 0) {
            wishList.innerHTML = '<li class="list-group-item text-center py-4">Your wish is empty</li>';
