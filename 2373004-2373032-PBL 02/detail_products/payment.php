...
error_log("Session in payment: " . print_r($_SESSION, true));

// Ambil data pengiriman dari session
$shippingMethod = isset($_SESSION['shipping_method']) ? $_SESSION['shipping_method'] : [
  'nama' => 'Express Shipping',
  'harga' => 15.00 // Nilai default
];

$shipping = $shippingMethod['harga'];

// Ambil subtotal dari session
...
// Simpan total di session untuk proses pembayaran
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $total = $_SESSION['total']; // Total dari session
  ...
  if ($metode_pembayaran === 'credit_card') {
    $no_kartu = $_POST['card_number'];
    $nama_pemegang = $_POST['card_name'];
    $expiry = $_POST['expiry_date'];
    $cvv = $_POST['cvv'];
  } else if ($metode_pembayaran === 'paypal') {
    $no_telepon = $_POST['phone_number'];
  }

  // Simpan ke tabel pembayaran
  $sql = "INSERT INTO pembayaran (signup_id, tanggal_pembayaran, metode_pembayaran, jumlah, status, no_kartu, nama_pemegang_kartu, expiry_date, cvv, no_telepon)
  ...
  if ($stmt->execute()) {
    // Hapus session shipping dan keranjang
    ...
    // Tampilkan error jika diperlukan
...
// Ambil data keranjang dari database berdasarkan session
$cartItems = [];
$subtotal = 0;
...
// Ambil detail opsi pengiriman
$shipping_option_id = $order_data['shipping_option'];
$sql_shipping = "SELECT * FROM opsi_pengiriman WHERE opsi_pengiriman_id = $shipping_option_id";
$result_shipping = $conn->query($sql_shipping);
$shipping_option = $result_shipping->fetch_assoc();
$shipping_cost = $shipping_option['harga_pengiriman'];
...
<head>
  ...
  <title>Payment - CUMBREPACK</title>
      ...
      <div class="row">
        ...
        <div class="col-lg-5 order-lg-2">
          <div class="order-summary p-4 border">
            ...
            <div class="shipping-info mb-4 pb-4 border-bottom">
              <?php
            ...
            <div class="shipping-method mb-4 pb-4 border-bottom">
        ...
        <div class="col-lg-7 order-lg-1">
          <div class="checkout-form">
            ...
            <div class="payment-options mb-4">
              <div class="form-check mb-3 border p-3 rounded">
                ...
                <div class="credit-card-icons mt-2">
                  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/visa/visa-original.svg" width="40"
                    alt="Visa">
              ...
              <div class="form-check border p-3 rounded">
                ...
                <div class="paypal-logo mt-2">
                  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/paypal/paypal-original.svg" width="80"
                    alt="PayPal">
                </div>
              </div>
            </div>
            ...
            <form id="paymentForm" method="POST">
              <div id="creditCardFields">
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="card_name" id="card_name" placeholder="John Doe"
                      required>
                  </div>
              ...
              <input type="hidden" name="signup_id" value="<?php echo $_SESSION['signup_id']; ?>">

              <div class="d-flex justify-content-between">
                <a href="order.html" class="btn btn-outline-dark py-3 px-4">Back to Shipping</a>
                <button type="submit" class="btn btn-dark py-3 px-5">Complete Order</button>
              </div>
            </form>
          </div>
        </div>
