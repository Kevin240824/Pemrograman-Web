...
<body>
  ...
  <div class="user-section d-none">
        ...
        <div class="container-lg">
            <div class="row">
                <div class="col-lg-5 py-5 my-5">
                    <h2 class="display-2 text-capitalize"><span class="fw-medium">Responsible </span>Adventures,<span
                            class="fw-medium text-primary">Preserved Peaks</span></h2>
                    <p class="fs-5">We Climb with Care—For the Mountains and Their Future.</p>
    ...
    <section>
        <div class="Sustain">
            <p>
            <h1>Our obsession with design is not just about a jacket</h1><br>


            Design is a matter of consequence. We have to think beyond the immediate goal of crafting exceptional
            product - we need to think about our impact on people and the planet. The urgency of the climate crisis
            broadens how we think about ourselves and the way we approach business.<br>

            We want to use the best materials and create the most refined and durable products possible. We want to make
            it easier for you to keep your gear in play. We want to empower people to find inspiration in nature, design
            and one another. We want to acknowledge our interdependence with one another and the living world, and that
            climate justice can’t be achieved without addressing global inequities, together.<br>

            Guided by design, community, science and passion, we have committed to halve our environmental footprint and
            grow our positive social impact. We align with the circularity principles of the Ellen MacArthur Foundation,
            and are pursuing circularity as part of our path to net zero.<br>

            Here is how we are going about it.<br><br>

            <h3>Collaborative low-carbon solutions</h3>

            CUMBREPACK was an early signatory to the UN Fashion Industry Charter for Climate Action (UN Fashion
            Charter),
            a member of the Outdoor Industry Association's Climate Action Corps, a co-founder alongside the Pembina
            Institute of the Catalyst Business Coalition and one of the first 1000 companies to set a verified
            <span>Science Based Target</span>. We are embracing the power of the collaborative to make structural change
            across industries,to meet the Paris Agreement targets and to scale low-carbon solutions.<br><br>

            <h3>Think long-term</h3>

            We put our best energy into designing our gear. We build it to last and endure the most extreme
            conditions.<br>
            Durability and performance have been our guiding principles from the outset.<br>
            However, 65% of a garment's environmental impact happens before you even see it- during manufacturing and
            sourcing. That is a problem that can be spread out across lifetimes, if the product is built to last- with
            timeless design, outstanding quality, dedicated durability. The most sustainable purchase is no purchase.
            Buying pre-loved <span>ReGEAR™</span> is your next best move. If you are going to purchase something new, we
            want to provide the best option - quality that will perform, season after season, with a line-up of willing
            users
            once your relationship with that garment comes to an end. Every time you choose to buy nothing new, to
            favour durability over disposability, to care for and repair your gear, or to support resale, repurposed or
            upcycled offerings, you're adding your weight to the growing shift towards circularity. <span>ReBIRD™</span>
            is a hub of initiatives where we are bringing circularity to life. <br><br>

            <b>Sustainability means thinking long-term. The climate emergency requires that we act with a sense of
                immediacy.</b><br>

            Navigating the future and the now is not easy, but we are up for the challenge<br>

            <i>We commit to a Science-Based Carbon Target on Climate Action.<br>
                We commit to working towards a circular economy.<br>
                We commit to connecting with and supporting communities working to remove barriers to the outdoors.<br>
                We commit to Fair Trade certification & improving working conditions everywhere we build products.<br><br>
            </i>

            Despite the complexity of the global problems we confront, being design-led means problem solving - a
            collaborative, humble, iterative process. Each step forward builds upon the last. This is the way we
            generate the momentum needed to catalyze systemic change. We commit to showing up.<br>
