                    ...
                    <ul
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu border-0 rounded-0 shadow" aria-labelledby="pages">
                                ...
                                <li><a href="../footer/Sustainbility_footer.html.html"
                                        class="dropdown-item">Sustainibility </a></li>
                ...
                <div
                    ...
                    <div class="user-section d-none">
                        <ul class="d-flex list-unstyled m-0 gap-3">
                            ...
                            <li>
                                <a href="#" class="p-2" title="Cart" data-bs-toggle="offcanvas"
                ...
                <div class="container">
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="compliance-badges">
                            <img src="/images/pci-compliant.png" alt="PCI Compliant" width="50">
                            <img src="/images/secure-checkout.png" alt="Secure Checkout" width="50">
                            <img src="/images/ssl-secure.png" alt="SSL Secure" width="50">
                        </div>
