            ...
            <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu border-0 rounded-0 shadow" aria-labelledby="pages">
                  ...
                  <li><a href="../footer/Sustainbility_footer.html" class="dropdown-item">Sustainibility </a></li>
        ...
        <div class="container-lg">
            <div class="row">
                <div class="col-lg-5 py-5 my-5">
                    <h2 class="display-2 text-capitalize"><span class="fw-medium">Contact </span>US<span
                            class="fw-medium text-primary"> Page</span></h2>
                    <p class="fs-5">Have a question? </p>
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="Contact">
                        ...
                        <H5>Join the team</H5><br>
                        <p>Live with Purpose. Work with Passion.<br><br>

                            All are welcome. At CUMBREPACK, we cultivate your growth and leadership both in your role
                            and
                            outside the office walls.<br><br>

                            We are actively fostering a culture of inclusivity, fuelled by curiosity and acceptance. Our
                            inclusive workplace includes virtual first arrangements where practicable, and is connected
                            to our core value 'Leave It Better'. We care about the uniqueness of our applicants,
                            employees, and guests; inclusion creates a healthier, happier workplace, drives creativity
                            and innovation, and reflects our interconnectedness with the communities in which we
                            operate.<br><br>

                            A dedicated “equity, diversity, and inclusion” team provides in-person and online trainings,
                            coaching, and Employee Belonging Councils to support team members from all backgrounds to do
                            our best work and to thrive. All applicants can expect fair treatment in the hiring process
                            in alignment with our values.</p><br><br><br>

                    </div>

                    <div class="job-section">
                        <img src="retail_regionalhub.jpg" alt="" class="job_img">
                        <h2>Retail and regional hub jobs</h2>
                        <p>Our global retail spaces invite guests to connect with the brand and become part of a
                            community. Regional hubs are key locations for the brand, providing signature experiences,
                            partnerships and next-level community offerings.</p>
                        <a href="#" class="view-jobs">View jobs</a>
                    </div>

                    <div class="job-section" >
                        <h2>Manufacturing and distribution centre jobs</h2>
                        <p>ABCOne, our New Westminster, BC hub for manufacturing and distribution, is the heart and
                            hands of Arc'heryx. Proximity to our Head Office and Design Centre lets us test designs and
                            processes in a real world manufacturing set-up for a direct flow of feedback between master
                            and designer. It's what makes the magic happen.</p>

                        <p class="highlight">ABCOne is one of Canada's Best Workplaces in Manufacturing (as declared in
                            the 2021 Great Place for Worker Canada survey). It offers team members an onsite gym, free
                            in and all-time to the nearby Styrian station, cultural celebrations and ESL courses.</p>
                    ...
                    <div class="job-section">
                        ...
                        <p>Where the strategic design, creative work and day-to-day business development happens. Our
                            original headquarters in the Coast Mountains, along with a number of key satellite hubs,
                            draws together people passionate in design, strategy and sustainability, (includes some
                            postings for international offices.)</p>
                        <a href="#" class="view-jobs">View jobs</a>
                    </div>
