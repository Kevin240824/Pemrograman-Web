...
<body>
  ...
  <div class="user-section d-none">
        ...
        <div class="container-lg">
            <div class="row">
                <div class="col-lg-5 py-5 my-5">
                    <h2 class="display-2 text-capitalize"><span class="fw-medium">About </span>Our Story <span
                            class="fw-medium text-primary">CUMBREPACK</span></h2>
                    <p class="fs-5">Whether you're looking for casual wear, formal attire, or seasonal outfits, we have
    ...
    <section>
        <div class="aboutus">
            <p><h3>About Us - CumbrePack: Inspired by the Mighty Mountains of Parahyangan</h3>

                At CumbrePack, we draw our strength and spirit from the towering peaks of Priangan (Parahyangan), the
                heartland of Sundanese culture, where the mountains stand as silent guardians of resilience, beauty, and
                adventure. Based in Bandung, a city cradled by volcanic slopes and lush highlands, we are a team of
                passionate hikers, designers, and craftsmen committed to creating high-quality, durable, and innovative
                gear for those who seek the summit.<br><br>

               <h4> Rooted in the Spirit of the Mountains </h4> 
                The name CumbrePack is derived from the Spanish word "Cumbre" (meaning "summit"), symbolizing our
                relentless pursuit of excellence—just like a mountaineer striving for the peak. But our soul belongs to
                Gunung Tangkuban Perahu, Gunung Gede, and the mystical landscapes of Sunda, where every trail tells a
                story of perseverance and tradition.<br>

                <h4> Crafted for Those Who Conquer </h4>
                We understand that every hike is a journey, and every journey demands reliable gear. That's why we
                meticulously design our backpacks, apparel, and accessories to withstand the toughest terrains while
                keeping comfort and functionality in mind. Whether you're trekking through Papandayan's misty trails or
                preparing for an alpine expedition, CumbrePack is built to empower your adventure.<br>

                <h4> Why Choose CumbrePack? </h4> 
                
                    ✔ Durability Meets Tradition - Our products blend modern engineering with inspiration from Sundanese
                craftsmanship.<br>

                   ✔ Tested in Priangan's Wilds - Every piece is field-tested in the rugged mountains of West Java.<br>
                
                   ✔ Proudly Bandung-Made - Supporting local artisans and sustainable production.<br>
               
               
                ✔ For the Pride of Every Hiker - We don't just sell gear; we equip legends.<br>

                Join us as we honor the majesty of Parahyangan's peaks and push the boundaries of outdoor innovation.
                Because at CumbrePack, the mountain isn't just a destination—it's our heritage.<br>
                
                <hr>

                <i >CumbrePack - Born in Bandung, Built for the Summit. </i>
                        ...
                        <div class="card-body px-0">
                            ...
                            <div class="post-header">
                                <h3 class="post-title mt-3">
                                    <a href="#" class="text-decoration-none text-capitalize">Brand's partnership announcement with materials manufacturer PT Radian Sinergi Utama</a>
                                </h3>
                                <p>Following the bran's partnership announcement with materials manufacturer PT Radian Sinergi, CUMBREPACK has been working to develop a new lightweight construction method. Dedicated to continuous innovation and problemsolving for the mountain athlete, CUMBREPACK obsesses over developing innovative solutions for fast and efficient travel in the mountains.
</p>
                            </div>
                        </div>
                    </article>
                ...
                <div class="col-md-4">
                    <article class="post-item card border-0 rounded-0">
                        ...
                        <div class="card-body px-0">
                            ...
                            <div class="post-header">
                                <h3 class="post-title mt-3">
                                    <a href="#" class="text-decoration-none text-capitalize">New Business Unit to Deepen Commitment to Mountain Footwear and Accelerate Growth
</a>
                                </h3>
                                <p>BANDUNG - April 22, 2025 - CUMBREPACK Equipment, the global design company specializing in technical high-performance apparel and equipment, today announced the formation of a dedicated Footwear Business Unit to accelerate the growth of its footwear category following the successful Spring 2025 launch of its expanded footwear collection. 
</p>
                            </div>
                        </div>
                    </article>
                ...
                <div class="col-md-4">
                    <article class="post-item card border-0 rounded-0">
                        ...
                        <div class="card-body px-0">
                            ...
                            <div class="post-header">
                                <h3 class="post-title mt-3">
                                    <a href="#" class="text-decoration-none text-capitalize">Industry Veteran Fiersa Besari Named Chief Merchandising Officer
</a>
                                </h3>
                                <p>Bandung, West Java(April 26, 2025) - CUMBREPACK Equipment, the global design company specializing in technical high-performance apparel and equipment, has announced the appointment of Matt Bolte as Chief Merchandising Officer. Additionally, the company named Marissa Pardini as General Manager and Ben Stubbington as Creative Director of its Veilance brand.
</p>
                            </div>
                        </div>
                    </article>
