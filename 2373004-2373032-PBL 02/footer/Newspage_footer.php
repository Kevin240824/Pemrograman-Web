 ...
 <header>
    ...
    <div class="container-lg">
      <div class="row">
        <div class="col-lg-5 py-5 my-5">
          <h2 class="display-2 text-capitalize"><span class="fw-medium">Our </span>CUMBREPACK <span
              class="fw-medium text-primary">Blog</span></h2>
          <p class="fs-5">Our Daily Blog.</p>
  ...
  <section id="Newspage">
    <div class="pages">
      ...
      <a href="../footer/sub_news/Newspage1.html"><img src="handshake_newspage.jpg" alt="">
        <a href="../footer/sub_news/Newspage1.html" class="nav-link">
          <h1>Brand's partnership
            announcement with materials manufacturer PT Radian Sinergi Utama</h1>
        </a>
      </a>
    ...
    <div class="pages">
      ...
      <a href="../footer/sub_news/Newspage2.html"><img src="mountaineering_newspage.jpg" alt="">
        <a href="../footer/sub_news/Newspage2.html" class="nav-link">
          <h1>>New Business Unit to Deepen
            Commitment to Mountain Footwear and Accelerate Growth</h1>
        </a>
      </a>
    ...
    <div class="pages">
      ...
      <a href="../footer/sub_news/Newspage3.html"><img src="fiersa besari_newspage.jpg" alt="">
        <a href="../footer/sub_news/Newspage3.html" class="nav-link">
          <h1>Industry Veteran Fiersa
            Besari Named Chief Merchandising Officer</h1>
        </a>
      </a>
  ...
  <section id="subscription">
    <div class="container-lg">
      ...
      <div class="bg-secondary text-light py-5" style="background: url('gear2.png') no-repeat; background-size: cover;">
        <div class="container">
          ...
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              ...
              <ul class="menu-list list-unstyled">
                ...
                </li>ref="#" class="nav-link">Delivery Information</a>
                </li>
              </ul>
            </div>
          </div>
