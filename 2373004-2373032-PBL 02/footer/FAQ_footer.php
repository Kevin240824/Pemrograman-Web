...
<body>
          ...
          <div class="col-sm-4 col-lg-2 text-center text-sm-start d-flex gap-3 justify-content-center justify-content-md-start">
            <div class="d-flex align-items-center my-3 my-sm-0">
              <!-- <a href="homepage.html"> -->
                <a href="../home/homepage.php" class="nav-link"><h3>CUMBREPACK</h3></a>
              </a>
            </div>
          </div>
        ...
        <option value="women.php">Women</option>
              ...
              <div class="col-11 col-md-7">
                <form id="search-form" class="text-center" action="index.html" method="post">
                  <input type="text" class="form-control border-0 bg-transparent" placeholder="Find your choice of clothing">
                </form>
              </div>              
              <div class="col-1">
                <a href="#">
  ...
  <div class="user-section d-none">
    ...
    <section style="background-image: url('himalaya.png');background-repeat: no-repeat;background-size: cover;">
        <div class="container-lg">
            <div class="row">
                <div class="col-lg-5 py-5 my-5">
                    <h2 class="display-2 text-capitalize"><span class="fw-medium">General </span>FAQ <span
                            class="fw-medium text-primary">CUMBREPACK</span></h2>
                    <p class="fs-5">"What's On Everyone's Mind?".</p>
    ...
    <section>
        <div class="FAQ">
            ...
            <h3>Orders</h3><br>
            # Do you offer exchanges?<br>
            Yes, we offer exchanges for items within 30 days of purchase, provided the product is unused, in its
            original packaging, and accompanied by a valid proof of purchase.<br>

            # Why was my order cancelled?<br>
            Orders may be cancelled due to insufficient stock, payment verification issues, or suspected fraudulent
            activity. You will receive an email notification with the specific reason for the cancellation.<br>

            # Do you offer price adjustments?<br>
            Yes, we offer price adjustments within 14 days of purchase if the item goes on sale. Contact our
            customer service with your order details to request an adjustment.<br>

            # Do I need to set up an account to place an order?<br>
            No, you can place an order as a guest. However, creating an account allows you to track your orders,
            save preferences, and enjoy faster checkout in the future.<br>

            <hr>

            <h3>Products</h3><br>

            # Where can I buy CUMBREPACK products?<br>
            CUMBREPACK products are available on our official website, authorized retailers, and select outdoor
            specialty
            stores. Visit our store locator for the nearest location.<br>

            # How can I get an CUMBREPACK sticker?<br>
            Stickers are often included with online orders or available at our retail stores. You can also request one
            by contacting customer service.<br>

            # How can I find out which size will fit me best?<br>
            Refer to our detailed size guide on the product page for measurements. If you need further assistance, our
            customer service team can help you find the perfect fit.<br>

            # Can I carry electronic items in my GORE-TEX garment?<br>
            Yes, GORE-TEX garments are designed to protect against the elements, but ensure electronic items are
            securely stored to avoid damage from moisture or impact.<br>

            # How can I get access to the CUMBREPACK Professional Use products?<br>
            Professional Use products are available to verified professionals in fields like search and rescue or
            guiding. Apply through our Professional Use Program on our website.<br>

            # How do I recognize a counterfeit?<br>
            Purchase only from authorized retailers, check for quality stitching, proper branding, and holographic tags.
            Report suspicious products to our customer service.<br>
            ...
            We accept major credit/debit cards (Visa, Mastercard, American Express), PayPal, Klarna (where available),
            and select regional payment options.<br>

            # Why was my payment declined?<br>
            Payments may be declined due to insufficient funds, incorrect card details, bank security restrictions, or
            billing address mismatches. Contact your bank or try an alternative payment method.<br>

            # What are pending, pre-authorized, and posted transactions?<br>
            - **Pending**: A temporary hold placed by your bank while verifying funds.
            - **Pre-authorized**: A reserved amount before finalizing the transaction.
            - **Posted**: The completed charge after order processing.<br>

            # Can I have a tax exemption applied to my order?<br>
            Tax exemptions apply only to eligible organizations (e.g., nonprofits, resellers with tax-exempt status).
            Submit your certificate during checkout or contact customer service.<br>

            # How much tax will I have to pay?<br>
            Tax depends on your shipping address and local regulations. Exact amounts are calculated at checkout.<br>
            ...
            # What is the CUMBREPACK Bulk Buying and Reselling policy?<br>
            Unauthorized bulk purchases for resale are prohibited. Authorized retailers must apply through our wholesale
            program. Violations may result in order cancellation.<br>

            # How does CUMBREPACK approach issues of social and environmental responsibility?<br>
            We prioritize sustainability through ethical sourcing, reducing PFAS, circular initiatives (e.g., ReBIRD
            repairs), and partnerships with environmental organizations.<br>

            # How can I verify if an email from CUMBREPACK is legitimate?<br>
            Check the sender's domain (@cumbrepack.com), avoid clicking suspicious links, and contact us directly if
            unsure. We never ask for passwords via email.<br

            <hr>

            <h3>Privacy</h3><br>

            # Is my personal information kept private?<br>
            Yes, we are committed to protecting your privacy. Your personal information is securely stored and only used
            for order processing, customer service, and (with your consent) marketing communications. We never sell your
            data to third parties. For details, please review our Privacy Policy.<br>

            # What are cookies? Should I be worried about them?<br>
            Cookies are small text files that help our website remember your preferences and improve your shopping
            experience. They're not harmful and you can manage them through your browser settings. We only use
            essential, performance, and functional cookies - you can opt out of non-essential cookies at any time.<br>
    ...
    <section id="subscription">
        <div class="container-lg">
            ...
            <div class="bg-secondary text-light py-5"
                style="background: url('gear2.png') no-repeat; background-size: cover;">
                <div class="container">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-md-5 p-5">
                            <div class="section-header">
                                <h2 class="section-title text-capitalize display-5 text-light">Get 25% Discount on your
                                    first purchase</h2>
                            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <article class="post-item card border-0 rounded-0">
                        <div class="image-holder zoom-effect">
                            <a href="#">
                                <img src="handshake.png" alt="post" class="card-img-top">
                            </a>
                        </div>
                        <div class="card-body px-0">
                            <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                                ...
                                <div class="meta-categories"><a href="#"
                                        class="text-secondary text-decoration-none">trending</a></div>
                            </div>
                            <div class="post-header">
                                <h3 class="post-title mt-3">
                                    <a href="#" class="text-decoration-none text-capitalize">Brand's partnership
                ...
                <div class="col-md-4">
                    <article class="post-item card border-0 rounded-0">
                        <div class="image-holder zoom-effect">
                            <a href="#">
                                <img src="mounteneering.png" alt="post" class="card-img-top">
                            </a>
                        </div>
                        <div class="card-body px-0">
                            <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                            ...
                            <div class="post-header">
                                <h3 class="post-title mt-3">
                                    <a href="#" class="text-decoration-none text-capitalize">New Business Unit to Deepen
                ...
                <div class="col-md-4">
                    <article class="post-item card border-0 rounded-0">
                        <div class="image-holder zoom-effect">
                            <a href="#">
                                <img src="fiersa.png" alt="post" class="card-img-top">
                            </a>
                        </div>
                        <div class="card-body px-0">
                            <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                                <div class="meta-date"><a href="#" class="text-secondary text-decoration-none">27 Apr
                                        2025</a></div>
                                <div class="meta-categories"><a href="#"
                                        class="text-secondary text-decoration-none">inspiration</a></div>
                            </div>
                            <div class="post-header">
                                <h3 class="post-title mt-3">
                                    <a href="#" class="text-decoration-none text-capitalize">Industry Veteran Fiersa
        ...
        <div class="container-lg">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer-menu">
                        <img src="logo.jpg" width="240" height="100" alt="logo">
            ...
            <div class="footer-menu">
              ...
              <ul class="menu-list list-unstyled">
                <li class="menu-item">
                  <a href="Aboutus_footer.html" class="nav-link">About us</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Conditions</a>
                </li>
                <li class="menu-item">
                  <a href="Newspage_footer.html" class="nav-link">Our Blog</a>
                </li>
                <li class="menu-item">
                  <a href="Career_footer.html" class="nav-link">Careers</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Sustainibility</a>
                </li>
              </ul>
            </div>
          </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      document.querySelector('.user-section').addEventListener('click', function (e) {
        if (e.target.closest('a[title="My Account"]')) {
          ...
          dropdown.innerHTML = `
         <a class="dropdown-item" href="../footer/Ordertrack_footer.html">TrackOrder</a>
        <a class="dropdown-item" href="../home/logout.php">History</a>
