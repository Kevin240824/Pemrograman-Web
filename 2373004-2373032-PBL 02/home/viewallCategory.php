...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../detail_products/detail_baselayer1.css">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap justify-content-between mb-3">
              ...
              <h2 class="section-title text-capitalize">View All</h2>
            <div class="d-flex align-items-center">
                <a href="homepage.php" class="btn btn-primary me-2">Back</a>
              </div>
            </div>
          </div>
            ...
            <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4">
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../sub_products/sub_baselayer.php" title="Product Title">
                      <img src="../imagecumbre/category/blayercategory.png" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Base Layer</h3>
                  </div>
                </div>
              </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../sub_products/sub_daypack.php" title="Product Title">
                      <img src="../imagecumbre/category/daypackcategory.png" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Day Pack</h3>
                  </div>
                </div>
              </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../sub_products/sub_gloves.php" title="Product Title">
                      <img src="../imagecumbre/category/glovescategory.png" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Gloves</h3>
                  </div>
                </div>
              </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../sub_products/sub_longs.php" title="Product Title">
                      <img src="../imagecumbre/category/pantscategory.png" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Long Pants</h3>
                  </div>
                </div>
              </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../sub_products/sub_wbreaker.php" title="Product Title">
                      <img src="../imagecumbre/category/wbreakercategory2.png" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Wind Breaker</h3>
                  </div>
                </div>
              </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../sub_products/sub_puff.php" title="Product Title">
                      <img src="../imagecumbre/category/puffcategory2.png" alt="Product Thumbnail" class="img-fluid" height="100px">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Puff Jacket</h3>
                  </div>
                </div>
              </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../sub_products/sub_wjacket.php" title="Product Title">
                      <img src="../imagecumbre/category/wjacketcategory.png" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Wind Breaker</h3>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../sub_products/sub_shoes.php" title="Product Title">
                      <img src="../imagecumbre/category/shoescategory.png" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Shoes</h3>
                  </div>
                </div>
              </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../sub_products/sub_carrier.php" title="Product Title">
                      <img src="../imagecumbre/category/carriercategory.png" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Carrier</h3>
                  </div>
                </div>
              </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../sub_products/sub_socks.php" title="Product Title">
                      <img src="../imagecumbre/category/sockscategory.png" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Socks</h3>
                  </div>
                </div>
              </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../sub_products/sub_shorts.php" title="Product Title">
                      <img src="../imagecumbre/category/short_category.png" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Short Pants</h3>
                  </div>
                </div>
              </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../sub_products/sub_tents.php" title="Product Title">
                      <img src="../imagecumbre/category/tents_category.png" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Short Pants</h3>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../sub_products/sub_hydropack.php" title="Product Title">
                      <img src="../imagecumbre/category/hydro_category.png" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Hydro Pack</h3>
                  </div>
                </div>
              </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../sub_products/sub_hat.php" title="Product Title">
                      <img src="../imagecumbre/category/hat_category.png" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Hats</h3>
                  </div>
                </div>
              </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../sub_products/sub_category.php" title="Product Title">
                      <img src="../imagecumbre/category/others_category.png" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Others</h3>
                  </div>
                </div>
              </div>
            </div>
