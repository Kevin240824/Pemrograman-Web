...
<div class="modal fade" id="loginModal" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <section style="background-image: url('../imagecumbre/home_display/women.png');background-repeat: no-repeat;background-size: cover;">
      <div class="container-lg">
        <div class="row">
          <div class="col-lg-5 py-5 my-5">
            <h2 class="display-2 text-capitalize"><span class="fw-medium">Women's </span>latest <span class="fw-medium text-primary">fashion trends</span></h2>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  ...
                  <div class="d-flex flex-column text-center">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$300.00</del>
                      <span class="text-dark fw-semibold">$290.00</span>
                      <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10% OFF</span>
                    </div>
                    <div class="button-area p-3 pt-0">
                      <div class="row g-1 mt-2">
