...
if (isset($_GET['login']) && $_GET['login'] === 'success') {
  echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
            Log in successful! You can now enter.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>';
}

// Tampilkan pesan error forgot -->
if (isset($_SESSION['forgot_error'])) {
  echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
            ' . htmlspecialchars($_SESSION['forgot_error']) . '
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>';
  unset($_SESSION['forgot_error']); // Hapus session setelah ditampilkan
}

// Tampilkan pesan sukses forgot -->
if (isset($_GET['forgot']) && $_GET['forgot'] === 'success') {
  echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
            Reset successful! You can now log in.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>';
}
...
<body>
  ...
  <section
    ...
    <div class="container-lg">
      <div class="row">
        <div class="col-lg-5 py-3 py-md-5 mt-0 mb-5 text-white">
        ...
        <div class="col-md-12">
          ...
          <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4">
            ...
            <div class="col">
              <div class="product-item mb-4">
                <figure>
                  <a href="../detail_products/detail_carrier1.php" title="Product Title">
        ...
        <div class="col-md-12">
          ...
          <div class="banner-blocks">
            ...
            <div class="banner-ad d-flex align-items-center large bg-info block-1"
              style="background: url('../imagecumbre/home_display/shoes2.png') no-repeat; background-size: cover;">
            ...
            <div class="banner-ad bg-success-subtle block-2"
              style="background:url('../imagecumbre/home_display/gear.png') no-repeat;background-size: cover">
            ...
            <div class="banner-ad bg-danger block-3"
              style="background:url('../imagecumbre/home_display/view.png') no-repeat;background-size: cover">
              <div class="banner-content align-items-center p-5">
                <div class="content-wrapper text-light">
            ...
            <div class="col-md-5 p-3">
              <form>
                <div class="mb-3">
                  ...
                  <input type="text" name="name_sub" class="form-control form-control-md rounded-0" name="name"
                    id="name" placeholder="Name">
                </div>
                <div class="mb-3">
                  <label for="email_sub" class="form-label d-none">Email</label>
                  <input type="email" class="form-control form-control-md rounded-0" name="email_sub" id="email"
      ...
      <div class="row">
        ...
        <div class="col-md-2 col-sm-6">
          <div class="footer-menu">
            ...
            <ul class="menu-list list-unstyled">
              <li class="menu-item">
                <a href="../footer/Aboutus_footer.php" class="nav-link">About us</a>
              </li>
              <li class="menu-item">
                <a href="#" class="nav-link">Conditions</a>
              </li>
              <li class="menu-item">
                <a href="../footer/Newspage_footer.php" class="nav-link">Our Blog</a>
              </li>
              <li class="menu-item">
                <a href="../footer/Career_footer.php" class="nav-link">Careers</a>
              </li>
              <li class="menu-item">
                <a href="../footer/Sustainbility_footer.php" class="nav-link">Sustainibility</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="col-md-2 col-sm-6">
          <div class="footer-menu">
            ...
            <ul class="menu-list list-unstyled">
              <li class="menu-item">
                <a href="/home/comboOffers.php" class="nav-link">Offers</a>
              </li>
              <li class="menu-item">
                <a href="#" class="nav-link">Stores</a>
              </li>
              <li class="menu-item">
                <a href="/home/onSale.php" class="nav-link">Shop</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="col-md-2 col-sm-6">
          <div class="footer-menu">
            ...
            <ul class="menu-list list-unstyled">
              <li class="menu-item">
                <a href="../footer/FAQ_footer.php" class="nav-link">FAQ</a>
              </li>
              <li class="menu-item">
                <a href="../footer/Contact_footer.php" class="nav-link">Contact</a>
              </li>
              <li class="menu-item">
                <a href="../footer/Policy_footer.php" class="nav-link">Privacy Policy</a>
              </li>
              <li class="menu-item">
                <a href="../footer/Refund_footer.php" class="nav-link">Returns & Refunds</a>
              </li>
              <li class="menu-item">
                <a href="../footer/Ordertrack_footer.php" class="nav-link">Delivery Information</a>
              </li>
            </ul>
          </div>
        </div>
  ...
  <script>
    ...
    function updateCartBadge() {
      fetch('../detail_products/get_cart_count.php')
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function addToCart() {
        ...
        fetch('../detail_products/add_to_cart.php', {
            method: 'POST',
            body: formData
          })
          .then(response => response.json())
      ...
      function updateCartDisplay() {
        fetch('../detail_products/get_cart.php')
          .then(response => response.json())
          .then(cartItems => {
      ...
      function removeItemFromCart(keranjangId) {
        if (confirm('Are you sure you want to remove this item?')) {
          ...
          fetch('../detail_products/remove_cart_item.php', {
              method: 'POST',
              body: formData
            })
            .then(response => response.json())
  ...
  <script>
    ...
    document.getElementById('continueToCheckout').addEventListener('click', function() {
      window.location.href = '../detail_products/order.php';
    });
  </script>
