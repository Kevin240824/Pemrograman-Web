...
<html lang="en">
  <head>
    <title>CUMBREPACK Outdoor Gear</title>
    <meta charset="utf-8">
          ...
          <div class="col-sm-4 col-lg-2 text-center text-sm-start d-flex gap-3 justify-content-center justify-content-md-start">
            <div class="d-flex align-items-center my-3 my-sm-0">
              <!-- <a href="homepage.html"> -->
                <a href="homepage.html" class="nav-link"><h3>CUMBREPACK</h3></a>
              </a>
            </div>
          </div>
...
<div class="modal fade" id="signupModal" tabindex="-1" aria-labelledby="signupModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="connect.php" method="post">
          ...
          <input type="submit" class="btn btn-primary w-100" name="user" >
        </form>
  ...
  <div class="user-section d-none">
    ...
    <section style="background-image: url('../imagecumbre/home_display/himalaya1.png');background-repeat: no-repeat;background-size: cover;">
      <div class="container-lg">
        <div class="row">
          <div class="col-lg-5 py-5 my-5 text-white">
            <h2 class="display-2 text-capitalize text-white"><span class="fw-medium">Discover </span>the latest <span class="fw-medium text-primary text-white">fashion trends</span></h2>
            <p class="fs-5 text-white" >Whether you're looking for casual wear, formal attire, or seasonal outfits, we have something for everyone.</p>
            <div class="d-flex gap-3">
              <a href="viewallProducts.html" class="btn btn-dark text-uppercase fs-6 rounded-pill px-5 py-4 mt-3">Start Shopping</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-12">
            ...
            <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4">
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../detail_products/detail_carrier1.html" title="Product Title">
                      <img src="../imagecumbre/carrier/carrier1.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Wolftrail Carrier 55+5L</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$440.00</del>
                      <span class="text-dark fw-semibold">$400.00</span>
                      <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10% OFF</span>
                    </div>
                    <div class="button-area p-3 pt-0">
                      <div class="row g-1 mt-2">
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../detail_products/detail_daypack1.html" title="Product Title">
                      <img src="../imagecumbre/daypack/daypack1.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Teqari 40 Daypack</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$180.00</del>
                ...
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/gloves/gloves1.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Rovos GripClimb V.1</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$90.00</del>
                      <span class="text-dark fw-semibold">$80.00</span>
                      <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10% OFF</span>
                    </div>
                    <div class="button-area p-3 pt-0">
                      <div class="row g-1 mt-2">
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/kaoskaki/kaoskaki1.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">ArkaTrail Socks</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$32.00</del>
                      <span class="text-dark fw-semibold">$22.00</span>
                      <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10% OFF</span>
                    </div>
                    <div class="button-area p-3 pt-0">
                      <div class="row g-1 mt-2">
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/blayer/blayer2.jpg" alt="Product Thumbnail" class="img-fluid" height="100px">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$120.00</del>
                      <span class="text-dark fw-semibold">$110.00</span>
                      <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10% OFF</span>
                    </div>
                    <div class="button-area p-3 pt-0">
                      <div class="row g-1 mt-2">
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/sepatu/sepatu1.jpeg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">TerraVibe Trail Pro</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$24.00</del>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="../imagecumbre/wjacket/wjacket1.jpg" alt="Product Thumbnail" class="img-fluid">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">StormGuard Waterproof Jacket</h3>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$120.00</del>
                      <span class="text-dark fw-semibold">$110.00</span>
                      <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10% OFF</span>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="banner-blocks">
              ...
              <div class="banner-ad d-flex align-items-center large bg-info block-1" style="background: url('../imagecumbre/home_display/shoes2.png') no-repeat; background-size: cover;">
              ...
              <div class="banner-ad bg-success-subtle block-2" style="background:url('../imagecumbre/home_display/gear.png') no-repeat;background-size: cover">
              ...
              <div class="banner-ad bg-danger block-3" style="background:url('../imagecumbre/home_display/view.png') no-repeat;background-size: cover">
                <div class="banner-content align-items-center p-5">
                  <div class="content-wrapper text-light">
    ...
    <section id="subscription">
      <div class="container-lg">
        ...
        <div class="bg-secondary text-light py-5" style="background: url('../imagecumbre/subs_img.png') no-repeat; background-size: cover;">
          <div class="container">
            <div class="row justify-content-center align-items-center">
              ...
              <div class="col-md-5 p-3">
                <form>
                  ...
                  <div class="mb-3">
                    <label for="email_sub" class="form-label d-none">Email</label>
                    <input type="email" class="form-control form-control-md rounded-0" name="email_sub" id="email" placeholder="Email Address">
                  </div>
                  <div class="d-grid gap-2">
                    <button type="submit" name="submit" class="btn btn-dark btn-md rounded-0">Submit</button>
                  </div>
                </form>
                        ...
                        <div class="card-body px-0">
                            ...
                            <div class="post-header">
                                <h3 class="post-title mt-3">
                                    <a href="../footer/sub_news/Newspage1.html" class="text-decoration-none text-capitalize">Brand's partnership
                ...
                <div class="col-md-4">
                    <article class="post-item card border-0 rounded-0">
                        ...
                        <div class="card-body px-0">
                            ...
                            <div class="post-header">
                                <h3 class="post-title mt-3">
                                    <a href="../footer/sub_news/Newspage2.html" class="text-decoration-none text-capitalize">New Business Unit to Deepen
                ...
                <div class="col-md-4">
                    <article class="post-item card border-0 rounded-0">
                        ...
                        <div class="card-body px-0">
                            ...
                            <div class="post-header">
                                <h3 class="post-title mt-3">
                                    <a href="../footer/sub_news/Newspage1.html" class="text-decoration-none text-capitalize">Industry Veteran Fiersa
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Sembunyikan user-icons awalnya
    userIcons.style.display = 'none';
    
    // Fungsi untuk menangani login/signup berhasil
    function handleAuthSuccess() {
      authButtons.style.display = 'none';
      userIcons.style.display = 'flex';
    }
    
    // Simulasikan login/signup berhasil (dalam aplikasi nyata ini akan dipanggil setelah auth berhasil)
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Cek status login awal (contoh: bisa dari localStorage)
  ...
  if (loginForm) {
    loginForm.addEventListener('submit', function(e) {
      e.preventDefault();
      // Simpan status login (dalam aplikasi nyata, ini akan setelah verifikasi server)
  ...
  if (signupForm) {
    signupForm.addEventListener('submit', function(e) {
      e.preventDefault();
      // Simpan status login (dalam aplikasi nyata, ini akan dilakukan setelah registrasi berhasil)
      localStorage.setItem('isLoggedIn', 'true');
      toggleAuthUI(true);
      // Tutup modal
      bootstrap.Modal.getInstance(document.getElementById('signupModal')).hide();
  ...
  // Logout functionality (contoh bisa ditambahkan di dropdown user icon)
  document.querySelector('.user-section a[title="My Account"]').addEventListener('click', function(e) {
    // Contoh: Tambahkan dropdown logout di sini
    console.log('User icon clicked - bisa ditambahkan dropdown menu');
  });
});
</script>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.querySelector('.user-section a[title="My Account"]').addEventListener('click', function(e) {
    ...
    // Buat dropdown menu untuk logout
    ...
    // Tambahkan dropdown ke DOM
    const userIcon = this.parentElement;
