...
<div class="modal fade" id="loginModal" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <section style="background-image: url('../imagecumbre/home_display/men.png');background-repeat: no-repeat;background-size: cover;">
      <div class="container-lg">
        <div class="row">
          <div class="col-lg-5 py-5 my-5">
            <h2 class="display-2 text-capitalize"><span class="fw-medium">Men's </span> latest <span class="fw-medium text-primary">fashion trends</span></h2>
