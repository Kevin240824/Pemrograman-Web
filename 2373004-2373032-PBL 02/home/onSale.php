        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap justify-content-between mb-3">
              ...
              <h2 class="section-title text-capitalize">Items On SALE</h2>
          ...
          <div class="col-md-12">
            ...
            <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4">
                ...
                <div class="product-item mb-4">
                  ...
                  <div class="d-flex flex-column text-center">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      ...
                      <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">30% OFF</span>
                    </div>
              ...
              <div class="col">
                <div class="product-item mb-4">
                  ...
                  <div class="d-flex flex-column text-center">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$440.00</del>
                      <span class="text-dark fw-semibold">$308.00</span>
                      <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">30% OFF</span>
                    </div>
                    <div class="button-area p-3 pt-0">
                      <div class="row g-1 mt-2">
              ...
              <div class="col">
                <div class="product-item mb-4">
                  <figure>
                    <a href="../detail_products/detail_daypack1.php" title="Product Title">
                  ...
                  <div class="d-flex flex-column text-center">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$180.00</del>
                      <span class="text-dark fw-semibold">$126.00</span>
                      <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">30% OFF</span>
                    </div>
                    <div class="button-area p-3 pt-0">
                      <div class="row g-1 mt-2">
              ...
              <div class="col">
                <div class="product-item mb-4">
                  ...
                  <div class="d-flex flex-column text-center">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$90.00</del>
                      <span class="text-dark fw-semibold">$63.00</span>
                      <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">30% OFF</span>
                    </div>
                    <div class="button-area p-3 pt-0">
                      <div class="row g-1 mt-2">
              ...
              <div class="col">
                <div class="product-item mb-4">
                  ...
                  <div class="d-flex flex-column text-center">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$32.00</del>
                      <span class="text-dark fw-semibold">$22.40</span>
                      <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">30% OFF</span>
                    </div>
                    <div class="button-area p-3 pt-0">
                      <div class="row g-1 mt-2">
              ...
              <div class="col">
                <div class="product-item mb-4">
                  ...
                  <div class="d-flex flex-column text-center">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$120.00</del>
                      <span class="text-dark fw-semibold">$84.00</span>
                      <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">30% OFF</span>
                    </div>
                    <div class="button-area p-3 pt-0">
                      <div class="row g-1 mt-2">
              ...
              <div class="col">
                <div class="product-item mb-4">
                  ...
                  <div class="d-flex flex-column text-center">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <del>$24.00</del>
                      <span class="text-dark fw-semibold">$16.80</span>
                      <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">30% OFF</span>
                    </div>
                    <div class="button-area p-3 pt-0">
                      <div class="row g-1 mt-2">
